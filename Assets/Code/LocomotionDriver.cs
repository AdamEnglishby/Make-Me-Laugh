...
public abstract class LocomotionDriver : MonoBehaviour
{
    ...
    [Header("Navigation Parameters")] public float navigationTolerance = 0.25f;
    ...
    private void Move()
    {
        ...
        animator.SetFloat(_speedParam,
            MovementEnabled ? moveMagnitudeToAnimationParam.Evaluate(MoveDirection.magnitude) : 0);
